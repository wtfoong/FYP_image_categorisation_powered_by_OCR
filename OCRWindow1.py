...
class Ui_OCRWindow(object):
    def setupUi(self, OCRWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 30, 1061, 99))
        ...
        self.btnOCR = QtWidgets.QPushButton(self.centralwidget)
    ...
    def retranslateUi(self, OCRWindow):
        ...
        self.txtImage.setPlaceholderText(_translate("OCRWindow", "Path to images to be categorised"))
